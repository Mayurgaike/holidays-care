...
export default function GalleryPage() {
  ...
  return (
    <>
      <SEO
        title="Travel Gallery | Holidays Care Memories"
        description="Explore beautiful travel memories captured during our tours across India and worldwide."
        keywords="travel gallery, tour photos, holidays care gallery"
        image="/memory1.jpeg"
