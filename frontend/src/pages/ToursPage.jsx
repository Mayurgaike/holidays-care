...
const ToursPage = () => {
  ...
  return (
    <>
      <SEO
        title="Explore Tour Packages | Domestic & International"
        description="Browse domestic and international tour packages with best pricing and curated experiences."
        keywords="tour packages India, international tours, travel deals"
