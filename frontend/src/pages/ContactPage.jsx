...
const ContactPage = () => {
  ...
  return (
    <>
      <SEO
        title="Contact Holidays Care | Book Your Tour Today"
        description="Get in touch with Holidays Care for travel bookings, packages, and queries."
        keywords="contact travel agency Nashik, book tour India"
          ...
          <Box sx={{ flex: 1, width: { xs: "100%", md: "50%" } }}>
            ...
            <Stack spacing={3}>
              ...
              <Stack direction="row" spacing={2} alignItems="flex-start">
                ...
                <Typography>
                  Roongta Shopping Hub, Nashik, Maharashtra
                </Typography>
              </Stack>
            </Stack>
