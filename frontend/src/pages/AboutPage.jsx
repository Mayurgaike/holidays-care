...
const AboutPage = () => {
  ...
  return (
    <>
      <SEO
        title="About Holidays Care | Trusted Travel Experts"
        description="Learn about Holidays Care, a trusted travel agency offering customized domestic and international tours."
        keywords="about holidays care, travel company Nashik, tour agency India"
        image="/aboutUs.jpeg"
            ...
            >
              ...
              <Box sx={{ flex: 1 }}>
                <Typography sx={{ mb: 3, lineHeight: 1.8 }}>
                  ...
                  unforgettable travel experiences for individuals, families,
                  and corporate groups. We specialize in organizing domestic and
                  international holiday packages tailored to each traveler’s
                  preferences and budget.
                </Typography>

                <Typography sx={{ mb: 3, lineHeight: 1.8 }}>
                  Our expert team carefully plans every aspect of your trip —
                  from flight reservations and hotel accommodations to
                  customized itineraries and documentation assistance.
                </Typography>
